...
class Cleanup:
    ...
    def time_entries(config=None, *ids):
        ...
        Cleanup._ids_cleanup('workspaces/{}/time_entries'.format(config.default_wid), config, False, *ids)
    ...
    def projects(config=None, *ids):
        ...
        Cleanup._ids_cleanup('workspaces/{}/projects'.format(config.default_wid), config, False, *ids)
